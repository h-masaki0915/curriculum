...
-- [回答] 
select stock_table.quantity, goods_table.goods_name, store_table.store_name
from stock_table, goods_table, store_table
where stock_table.goods_code = goods_table.goods_code
and store_table.store_code = stock_table.store_code;
