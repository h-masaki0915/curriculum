...
public class ExException {
 ...
 case CONST_EXCEPTION_TRIGER_NULL:
  ...
  // ルール: ここへ作成したメソッドを呼び出す
     String nullPo = ("テスト");
     try {
        if (!nullPo.equals(CONST_COMMON_INIT_INFO)) {
 ...
 case CONST_EXCEPTION_TRIGER_ARRAY_OUT_OF_BOUNDS:
  ...
  // ここへ記述
     int[] trigerArray = {1,2,3};
     System.out.println(trigerArray[5]);
 break;
 ...
 */
  // ここへ記述
 private static void nullPoint(String nullPo) {
     System.out.print(nullPo);
 }
 /**
 * 例外処理のメッセージを出力
 *
